...
import it.uninsubria.myaudio.R.*
...
class PlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(layout.player_activity)
        ...
        seekBar = findViewById(id.seekBar_play)
        textViewFileName = findViewById(id.tv_nameFile1)
        tvTimeLeft= findViewById(id.tv_timeleft)
        tvTimeRight=findViewById(id.tv_timeright)
        mediaPlayer.apply {
    ...
    private fun playPause(){
        if(!mediaPlayer.isPlaying){
            mediaPlayer.start()
            btnPlay.background = ResourcesCompat.getDrawable(resources , drawable.ic_round_pause_circle_filled_24 , theme)
    ...
    private fun stop(){
        btnPlay.background = ResourcesCompat.getDrawable(resources , drawable.ic_round_play_circle_filled_24 , theme)
